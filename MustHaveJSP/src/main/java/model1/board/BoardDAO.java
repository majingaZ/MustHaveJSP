...
public class BoardDAO extends JDBConnect {
	...
	public List<BoardDTO> selectList(Map<String, Object> map) {
		...
		try {
			...
			rs = stmt.executeQuery(query); // 쿼리 실횅

			while (rs.next()) { // 결과 순화하며 한 행의 내용을 DTO에 저장
	...
	public BoardDTO selectView(String num) {
		...
		try {
			...
			if (rs.next()) {
				...
				dto.setName(rs.getString("naem"));
			}
		} catch (Exception e) {
			System.out.println("게시물 상세보기 증 예외 발생");
			e.printStackTrace();
		}
